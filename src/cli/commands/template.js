...
exports.registerTemplateCommand = registerTemplateCommand;
const tslib_1 = require("tslib");
const TemplateManager_1 = require("../../services/TemplateManager");
const ora_1 = tslib_1.__importDefault(require("ora"));
const VALID_TYPES = ['project', 'modules', 'component'];
const VALID_MIRRORS = ['github', 'gitee'];
/** 模板类型中文描述 */
const TYPE_LABELS = {
...
function registerTemplateCommand(program) {
    ...
    template
        ...
        const mirror = VALID_MIRRORS.includes(options.mirror)
            ? options.mirror
            : 'github';
        ...
        if (options.type) {
            ...
            try {
                await manager.ensureTemplateRepo(options.type, {
                    mirror,
                    force: true,
                });
