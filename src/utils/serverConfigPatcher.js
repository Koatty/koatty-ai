...
exports.PROTOCOL_TYPES = void 0;
exports.addProtocolToServerConfig = addProtocolToServerConfig;
const tslib_1 = require("tslib");
const fs = tslib_1.__importStar(require("fs"));
const path = tslib_1.__importStar(require("path"));
/** 需要特殊配置的协议类型 */
exports.PROTOCOL_TYPES = ['grpc', 'graphql', 'websocket', 'ws'];
/** 协议名映射：websocket -> ws */
const PROTOCOL_MAP = {
    websocket: 'ws',
    grpc: 'grpc',
 ...
 */
function addProtocolToServerConfig(cwd, protocolType) {
...
//# sourceMappingURL=serverConfigPatcher.js.map