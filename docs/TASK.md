...
### Task 7: 实现 `generate:module` 命令骨架
**目标**: 创建模块生成命令（无实现）
**输出**:
...
### Task 24: 创建 Service 模板
**目标**: 实现 Service 生成模板
**输出**:
- `templates/service/service.hbs` 文件
**验证**: 渲染后代码语法正确

### Task 25: 创建 Controller 模板
